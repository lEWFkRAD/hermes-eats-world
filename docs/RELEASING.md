...
git tag -s v1.1.0 -m "Hermes Eats World v1.1.0"
...
sources, reruns tests and dependency auditing, builds the wheel, creates a build
provenance attestation, and publishes the GitHub Release with the wheel attached.
